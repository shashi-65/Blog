...
mongoose.connect("mongodb+srv://shashi:d2k6uQhgWjelc5Vu@cluster0.isqavoh.mongodb.net/blogDB");
...
app.get('/', (req, res) => {
  ...
  // res.render("home", {homeText: homeStartingContent, dailyUpdates: posts}); 
});
